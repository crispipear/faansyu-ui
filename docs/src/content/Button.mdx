...
import { Header, Button, IconButton } from 'faanshu-ui'
...
<Header anchor as="h2">Basic Button styles</Header>
<Demo
  code={
    createCodeString({
      component: "Button",
...
<Header anchor as="h2">Link Button</Header>
...
<Header anchor as="h2">Loading Button</Header>
<Demo
  code={
    createCodeString({
      component: "Button",
...
<Header anchor as="h2">Disabled Button</Header>
<Demo
  code={
    createCodeString({
      component: "Button",
...
<Header anchor as="h2">Icon Button</Header>
